import { FormatSelect, SyncCenteredState } from '/@/renderer/features/sync/components/shared';
    ...
    const formatControl = (
        <FormatSelect
            description={
                ...
                format === 'rekordbox'
                    ? 'Read a collection XML exported from Rekordbox.'
                    : format === 'serato'
                      ? 'Read crates straight out of your Serato library.'
                      : undefined
            }
